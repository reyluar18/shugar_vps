...
cd /usr/local/bin
wget -O premium-script.tar.gz "https://raw.githubusercontent.com/reyluar18/shugar_vps/master/premium-script.tar.gz"
...
chmod +x /usr/local/bin/shugar_others
chmod +x /usr/local/bin/shugar_pptp
chmod +x /usr/local/bin/shugar_sshovpn
chmod +x /usr/local/bin/shugar_vpssection
