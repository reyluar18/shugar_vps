...
read -p "Database Name    : " -e -i Shugar NamaDatabase
echo "Input MySQL Password:"
echo "(Use different Password for your database, dont use VPS password.)"
read -p "Database Password: " -e -i Shugar PasswordDatabase
echo ""
...
if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/reyluar18/shugar_vps/master/rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
  rpm -Uvh rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
else
  wget https://raw.githubusercontent.com/reyluar18/shugar_vps/master/rpmforge-release-0.5.3-1.el6.rf.i686.rpm
...
echo "Modified by Shugar"                      	                 	| tee -a log-install-ocspanel.txt
echo "--------------------------------------------------------------------------------"| tee -a log-install-ocspanel.txt
echo ""
echo ""
cd